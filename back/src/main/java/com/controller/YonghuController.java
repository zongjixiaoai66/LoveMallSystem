...
//            return R.error(511,"永远不会进入");
    ...
    */
    ...
    public R shenhe(@RequestBody YonghuEntity yonghuEntity, HttpServletRequest request){
        ...
        YonghuEntity oldYonghu = yonghuService.selectById(yonghuEntity.getId());//查询原先数据
...
//                            yonghuEntity.setYonghuYesnoTypes(Integer.valueOf(data.get(0)));   //报名状态 要改的
...
//                            yonghuEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        else if(yonghu.getYonghuYesnoTypes()==3)
            return R.error("审核被拒绝");
