    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">爱心商城系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="企业姓名" class="input" v-if="tableName=='qiye'">
                            <el-input v-model="ruleForm.qiyeName" autocomplete="off" placeholder="企业姓名"  />
                        </el-form-item>
                        <el-form-item label="企业手机号" class="input" v-if="tableName=='qiye'">
                            <el-input v-model="ruleForm.qiyePhone" autocomplete="off" placeholder="企业手机号"  />
                        </el-form-item>
                        <!--
                            <el-form-item v-if="qiyePhotoFlag">
                            </el-form-item>
                            <el-form-item label="企业头像" class="input" v-if="tableName=='qiye'">
                                    <file-upload
                                        tip="点击上传企业头像"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='qiye'">
                        ...
                        -->
                        <!--
                            <el-form-item label="报名状态" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.yonghuYesnoTypes" autocomplete="off" placeholder="报名状态"  />
                           </el-form-item>
                        -->
                        <!--
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // }
                            // yonghu 中的 报名状态 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.yonghuYesnoTypes== null ||this.ruleForm.yonghuYesnoTypes== "")){
...
.container {
    ...
    background-repeat: no-repeat;
        background-image: url(/aixinshangchengixitong/img/back-img-bg.jpg);
