        ...
        <el-dialog title="审核" :visible.sync="yonghuYesnoTypesVisible">
            <el-form :model="form">
                ...
                <el-form-item label="审核" >
                    <el-select v-model="form.yonghuYesnoTypes" placeholder="请选择报名状态">
            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '报名状态' : ''">
                        <el-select v-model="searchForm.yonghuYesnoTypes" placeholder="请选择报名状态">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/aixinshangchengixitong/upload/yonghuMuBan.xls"
                        >批量导入用户数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('yonghu','导入导出')"
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            yonghuUploadError(data){
                ...
                _this.form.id = null;
                _this.form.id = id;
                            _this.form.yonghuYesnoTypes = "请选择报名状态";
                _this.yonghuYesnoTypesVisible = true;
            },

            yonghuYesnoTypesShenhe() {
                let _this = this;
                if(_this.form.yonghuYesnoTypes == "请选择报名状态"){
