    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yonghuYesnoTypes" label="报名状态" prop="yonghuYesnoTypes">
                        <el-input v-model="ruleForm.yonghuYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
                <el-col :span="12">
