<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='qiye'"  label='企业姓名' prop="qiyeName">
               <el-input v-model="ruleForm.qiyeName"  placeholder='企业姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='qiye'"  label='企业手机号' prop="qiyePhone">
               <el-input v-model="ruleForm.qiyePhone"  placeholder='企业手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='qiye'" label='企业头像' prop="qiyePhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.qiyeName)&& 'qiye'==this.flag){
                             ...
                             if( 'qiye' ==this.flag && this.ruleForm.qiyePhone&&(!isMobile(this.ruleForm.qiyePhone))){
